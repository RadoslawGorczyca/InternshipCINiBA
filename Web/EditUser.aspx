<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="web.EditUser" %>
    ...
    <div class="mainwrapper">
        ...
        <table class="table">
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="BSave" runat="server" Text="Zapisz" OnClick="BSave_Click" />
                </td>
            </tr>
        </table>
    </div>
