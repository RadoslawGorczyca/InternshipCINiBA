<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FailureOthers.aspx.cs" Inherits="web.FailureOthers" %>
...
<body>
    ...
    <div class="mainwrapper">
        <div class="header">
            <h1><a href="Default.aspx">Strona główna</a> - <a href="FailureService.aspx">Zlecenia cudze</a></h1>
        </div>
       ...
       <div class="menuHeader">
        ...
        <table class="table2">
            <tr>
                <td>Treść</td>
                <td style="width:20%; border-left: 1px #CCC solid;"><a href="FailureOthers.aspx<% Response.Write(getSort()); %>" style="width: 100%;background-repeat:no-repeat; background-position: 0 center; padding-left: 12px";
