...
namespace web
{
    public partial class FailureOthers : System.Web.UI.Page
    {
        ...
        public String getPagination()
        {
            ...
            else
            {
                ...
                if (page > 3)
                {
                    output += "<a href='FailureOthers.aspx?page=1" + sortBy + "'><<</a>";
                }

                if (page > 1)
                {
                    output += "<a href='FailureOthers.aspx?page=" + (page - 1) + "" + sortBy + "'><</a>";
                }

                for (int i = iStart - 1; i < Math.Ceiling(iNum / (decimal)numOfQPerPage) && i < iStart + 8; i++)
                {
                    output += "<a href='FailureOthers.aspx?page=" + (i + 1) + "" + sortBy + "'" + ((i + 1) == page ? " class='active'" : "") + ">" + (i + 1) + "</a>";
                }
                ...
                {
                    output += "<a href='FailureOthers.aspx?page=" + Math.Ceiling(iNum / (decimal)numOfQPerPage) + "" + sortBy + "'>>></a>";
                }
            }
